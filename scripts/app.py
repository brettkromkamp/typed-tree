...
tree.add_node(
    "Lyndon Rive", parent_pointer="Elon Musk", node_type="person", edge_type="family"
)
tree.add_node(
    "SpaceX", parent_pointer="Elon Musk", node_type="company", edge_type="founder"
)
tree.add_node(
    "Tesla", parent_pointer="Elon Musk", node_type="company", edge_type="founder"
)
tree.add_node(
    "Solar City",
...
tree.add_node(
    "Falcon 9", parent_pointer="SpaceX", node_type="rocket", edge_type="technology"
)
tree.add_node(
    "Falcon Heavy", parent_pointer="SpaceX", node_type="rocket", edge_type="technology"
)
tree.add_node(
    "Dragon", parent_pointer="SpaceX", node_type="space-ship", edge_type="technology"
)
